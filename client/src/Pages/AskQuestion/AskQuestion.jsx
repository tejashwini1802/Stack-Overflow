        ...
        <form onSubmit={ handleSubmit }>
            <div className='ask-form-container'>
              <label htmlFor='ask-ques-title'>
                ...
                <input type="text" name='questionTitle' id='ask-ques-title' onChange = { (e) => { setQuestionTitle( e.target.value )}} placeholder='e.g. is there an R function for finding the indexof an element in a vector?'/> 
              </label>
